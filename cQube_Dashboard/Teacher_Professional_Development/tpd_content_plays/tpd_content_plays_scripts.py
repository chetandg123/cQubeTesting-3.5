...
class tpd_content_plays_map_report():
    ...
    def check_navigation_from_dashboard(self):
        ...
        data.navigate_to_tpd_content_plays_report()
        if 'tpd-total-content-plays' in self.driver.current_url:
            print("TPD Content Plays report is displayed")
        else:
            print('TPD Content Plays report is not displayed')
    ...
    def check_report_home_page(self):
        ...
        self.driver.find_element(By.ID.Data.cQube_logo).click()
        time.sleep(1)
        self.data.navigate_to_tpd_content_plays_report()
        if 'No data found' in self.driver.page_source:
            print("TPD Content Plays Report is showing no data found!!!")
            count = count + 1
