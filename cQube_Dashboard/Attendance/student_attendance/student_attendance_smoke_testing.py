...
class cQube_Student_Attendance(unittest.TestCase):
    ...
    #     state = GetData()
    #     state.click_on_state(self.driver)
    #     year = Select(self.driver.find_element_by_id(Locators.sar_year))
    #     try:
    ...
    #     state = GetData()
    #     state.click_on_state(self.driver)
    #     year = self.driver.find_element_by_id(Locators.sar_year)
    #     month = Select(self.driver.find_element_by_id(Locators.sar_month))
    #     try:
